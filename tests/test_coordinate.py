...
class TestCoordinate:
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                ...
                50,
                "chr2:1000-2000",
            ),  # happy path with different padding
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                200,
                0,
                "<Coordinate object; coordinate=chr1:100-200; padding=0>",
            ),  # happy path, no padding
            (
                "chrX",
                5000,
                5500,
                100,
                "<Coordinate object; coordinate=chrX:5000-5500; padding=100>",
            ),  # happy path with padding
            (
                "chr2",
                1000,
                2000,
                50,
                "<Coordinate object; coordinate=chr2:1000-2000; padding=50>",
            ),  # happy path with different padding
            (
                "chr1",
                0,
                1,
                0,
                "<Coordinate object; coordinate=chr1:0-1; padding=0>",
            ...
            (
                ...
                16570,
                0,
                "<Coordinate object; coordinate=chrM:16569-16570; padding=0>",
            ),  # edge case, stop = start + 1
        ],
        ids=[
            "no_padding",
    ...
    @pytest.mark.parametrize(
        ...
        ids=[
            "start_greater_than_stop_no_padding",
            "start_greater_than_stop_with_padding",
        ],
    )
